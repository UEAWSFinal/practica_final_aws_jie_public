...
updateWeatherApp = (city) => {
    ...
    <div class="card-mid row">
          ...
          <div id="icon-container" class="icon-container card shadow mx-auto">
            <img src="${iconSrc}" alt="" />
          </div>
    ...
    if (isDayTime(imageName)) {
        console.log('day');
        document.getElementById('icon-container').style.background="#bddeff";
        ...
        console.log('night');
         document.getElementById('icon-container').style.background="#0c0d43";
